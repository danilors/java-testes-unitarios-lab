...
// Carrega o contexto da aplicação Spring Boot para testes de integração
@SpringBootTest

// Configura o MockMvc para simular requisições HTTP nos testes
@AutoConfigureMockMvc

// Garante que o contexto da aplicação seja reiniciado após cada método de teste
@DirtiesContext(classMode = DirtiesContext.ClassMode.AFTER_EACH_TEST_METHOD)

// Especifica o perfil ativo do Spring para os testes
@ActiveProfiles("test")
...
// A anotação @SpringBootTest é usada para indicar que a classe é um teste de integração do Spring Boot. Ela carrega o contexto do
// aplicativo e permite que você teste componentes do Spring, como controladores, serviços e repositórios, em um ambiente semelhante ao de produção.
